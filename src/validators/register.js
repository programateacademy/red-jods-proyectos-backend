...
const validateCreateUser = [
  ...
  check('last_name').exists().not().isEmpty().withMessage('El campo last_name es requerido').isAlpha().withMessage('El campo last_name solo debe contener letras'),
  ...
  check('role').exists().not().isEmpty().withMessage('El campo rol es requerido').isIn([ 'user']).withMessage('El campo rol debe ser igual a "user"'),
