...
const validateCreateProject = [
  ...
  check("title")
    ...
    .custom(onlyLettersAndSpaces)
    .withMessage("El campo debe contener únicamente letras y espacios"),
  check("axis")
    .exists()
    .not()
    .isEmpty()
    .withMessage("El campo ejes es requerido")
    .isIn(["Personas", "Prosperidad", "Planeta", "Paz", "Alianzas"])
    .withMessage(
      'El campo rol debe ser igual a "Personas", "Prosperidad","Planeta","Paz" o "Alianzas"'
    ),

  check("ods")
    .isArray()
    .withMessage("El campo ods debe ser un arreglo")
    .custom((arreglo) => {
  ...
  check("indicator")
    ...
    .not()
    .isEmpty()
    .withMessage("El campo indicator es requerido")
    .custom(onlyLettersAndSpaces)
    .withMessage("El campo debe contener únicamente letras y espacios"),
  check("objective")
    .exists()
    .not()
    .isEmpty()
    .withMessage("El campo objective es requerido")
    .custom(onlyLettersAndSpaces)
    .withMessage("El campo debe contener únicamente letras y espacios"),
  check("doc")
    .exists()
    ...
    .withMessage("El campo objective es requerido")
    .isURL()
    .withMessage("El campo doc debe ser una URL válida"),

  check("task")
    .isArray()
    .withMessage("El campo task debe ser un arreglo")
    .custom((arreglo) => {
      arreglo.forEach((objeto) => {
        if (!objeto.name) {
        ...
        if (!onlyLettersAndSpaces(objeto.name)) {
          throw new Error(
            "El campo name de task solo puede contener nombre y espacios"
          );
        }
      });
      return true;
