...
const validateCreateUser = [
  check("name")
    ...
    .isAlpha()
    .withMessage("El campo name solo debe contener letras"),
  check("last_name")
    .exists()
    .not()
    .isEmpty()
    .withMessage("El campo last_name es requerido")
    .isAlpha()
    .withMessage("El campo last_name solo debe contener letras"),
  check("email")
    .exists()
    .not()
    .isEmpty()
  ...
  check("password")
    ...
    .withMessage("password debe tener entre 8 y 18 caracteres")
    .matches(/^(?=.*[A-Z])(?=.*\d).*$/)
    .withMessage(
      "password debe incluir al menos una letra mayúscula y un número"
    ),
  check("phone")
    .exists()
    .not()
    .isEmpty()
    .withMessage("El campo phone es requerido")
    .isNumeric()
  ...
  check("role")
    ...
    .isIn(["admin", "user"])
    .withMessage('El campo rol debe ser igual a "admin" o "user"'),
  check("state")
    .exists()
    .not()
    .isEmpty()
